 ...
 */
class MassWarm extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            $this->warmerService->warmPages($pageIds, 0);
        } catch (\Exception $e) {
            $this->messageManager->addErrorMessage($e->getMessage());
        }
        $this->messageManager->addSuccessMessage(
            __('A total of %1 Page(s) have been warmed.', count($pageIds))
        );
